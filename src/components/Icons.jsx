/**
 * Icons.jsx — Librería de iconos SVG profesionales
 * Todos los íconos son SVG inline para máximo control visual.
 * Basados en el estilo Heroicons / Lucide (líneas limpias, trazo 1.5).
 */
...
export function IconStethoscope(p) {
  return (
    <svg {...defaultProps} {...p} viewBox="0 0 24 24">
      <path d="M17 10c0-4.5-2.5-8-5-8S7 5.5 7 10c0 1.5.5 2.5 1.5 3.5C10 15 11 16 11 18v2a2 2 0 0 0 4 0v-2c0-2 1-3 2.5-4.5 1-.9 1.5-2 1.5-3.5Z" />
      <path d="M12 2v3m-5 5H4m13 0h3" />
    </svg>
  );
}
